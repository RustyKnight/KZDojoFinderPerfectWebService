//
//  DojoPictureHandler.swift
//  KZDojoFinderPerfectWebService
//
//  Created by Shane Whitehead on 18/04/2016.
...
*/
public class GetDojoPictureHandler: RequestHandler {
	...
	func queryForDatabase(parameters: [String: String]) -> Query {
		return Query(query: "select picture, picturetype from dojos where key = $1",
